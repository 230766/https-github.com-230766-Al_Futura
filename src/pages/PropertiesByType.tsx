...
const PropertiesByType = () => {
  ...
  // Generate title and description based on property type
  const getTitle = () => {
  ...
  const getDescription = () => {
    switch (type?.toLowerCase()) {
      case "residential":
        return "Discover premium residential investment opportunities in Dubai's most sought-after neighborhoods.";
      case "commercial":
        return "Explore high-yield commercial real estate investments in Dubai's thriving business districts.";
      case "vacation":
        return "Invest in luxury vacation properties in Dubai's most popular tourist destinations.";
      case "retail":
        return "Browse retail investment opportunities in Dubai's busiest shopping districts.";
      case "industrial":
        return "Discover industrial property investments in Dubai's growing logistics and manufacturing sectors.";
      default:
        return "Browse our complete collection of high-yield real estate investment opportunities in Dubai.";
    }
  };

        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/investor-protection" className="text-gray-400 hover:text-white">Investor Protection</Link></li>
              <li><Link to="/risk-disclosure" className="text-gray-400 hover:text-white">Risk Disclosure</Link></li>
            </ul>
          </div>
        </div>
      </div>
